...
def classify_by_boat(telemetry_status,start_time,end_time,dictionary,climpath,emolt_no_telemetry_path):
...
def update_dictionary(telemetry_status,start_time,end_time,dictionarypath,climpath,emolt_no_telemetry_path):
    ...
    obsdpogmf=classify_by_boat(telemetry_status,start_time,end_time,dictionary,climpath,emolt_no_telemetry_path)
